...
\brief Initiate touchlink actions.
...
typically only used for touchlinking.
...
unicasts a (dummy) message to the linked target, requesting a response. This is retried a few times.
If no response is received even after the retries, the linking is still considered to be partly
successfull, but it returns N_LinkInitiator_Status_CommunicationNotEstablished.
...
\internal
$Id: N_LinkInitiator.h 24615 2013-02-27 05:14:24Z arazinkov $
***************************************************************************************************/
