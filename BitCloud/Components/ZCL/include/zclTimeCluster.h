...
*******************************************************************************/
#define ZCL_TIME_CLUSTER_SERVER_ATTRIBUTES_AMOUNT      10
...
#define ZCL_DEFINE_TIME_CLUSTER_SERVER_ATTRIBUTES()\
  ...
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(timeZone, ZCL_READWRITE_ATTRIBUTE, ZCL_TIME_CLUSTER_SERVER_TIME_ZONE_ATTRIBUTE_ID, ZCL_32BIT_DATA_TYPE_ID, ZCL_TIME_ZONE_MIN_VALUE, ZCL_TIME_ZONE_MAX_VALUE),\
  ...
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(dstShift, ZCL_READWRITE_ATTRIBUTE, ZCL_TIME_CLUSTER_SERVER_DST_SHIFT_ATTRIBUTE_ID, ZCL_32BIT_DATA_TYPE_ID, ZCL_DST_SHIFT_MIN_VALUE, ZCL_DST_SHIFT_MAX_VALUE),\
  ...
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(lastSetTime, ZCL_READONLY_ATTRIBUTE, ZCL_TIME_CLUSTER_SERVER_LAST_SET_TIME_ATTRIBUTE_ID, ZCL_UTC_TIME_DATA_TYPE_ID, 0x00000000, 0xFFFFFFFE),\
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(validUntilTime, ZCL_READWRITE_ATTRIBUTE, ZCL_TIME_CLUSTER_SERVER_VALID_UNTIL_TIME_ATTRIBUTE_ID, ZCL_UTC_TIME_DATA_TYPE_ID, 0x00000000, 0xFFFFFFFE)
/***************************************************************************//**
