/***************************************************************************//**
  \file zclIlluminanceMeasurementCluster.h

  \brief
    The header file describes the ZCL  zcl Illuminance Measurement Cluster and its interface

    The file describes the types and interface of the ZCL Illuminance measurement Configuration Cluster
...
#define ZCL_DEFINE_ILLUMINANCE_MEASUREMENT_CLUSTER_SERVER_ATTRIBUTES(min, max) \
    ...
    DEFINE_REPORTABLE_ATTRIBUTE_WITH_BOUNDARY(tolerance, ZCL_READONLY_ATTRIBUTE, ZCL_ILLUMINANCE_MEASUREMENT_CLUSTER_TOLERANCE_SERVER_ATTRIBUTE_ID, ZCL_U16BIT_DATA_TYPE_ID, min, max, 0x0000, 0x0800)
