...
#define DEFINE_COLOR_CONTROL_CLUSTER_ATTRIBUTES() \
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(currentHue,                 ZCL_READONLY_ATTRIBUTE, ZCL_ZLL_CLUSTER_CURRENT_HUE_SERVER_ATTRIBUTE_ID,                    ZCL_U8BIT_DATA_TYPE_ID, 0x00, 0xFE),   \
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(currentSaturation,          ZCL_READONLY_ATTRIBUTE, ZCL_ZLL_CLUSTER_CURRENT_SATURATION_SERVER_ATTRIBUTE_ID,             ZCL_U8BIT_DATA_TYPE_ID, 0x00, 0xFE),   \
  ...
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(currentX,                   ZCL_READONLY_ATTRIBUTE, ZCL_ZLL_CLUSTER_CURRENT_X_SERVER_ATTRIBUTE_ID,                      ZCL_U16BIT_DATA_TYPE_ID, 0x0000, 0xFEFF), \
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(currentY,                   ZCL_READONLY_ATTRIBUTE, ZCL_ZLL_CLUSTER_CURRENT_Y_SERVER_ATTRIBUTE_ID,                      ZCL_U16BIT_DATA_TYPE_ID, 0x0000, 0xFEFF), \
  DEFINE_ATTRIBUTE_WITH_BOUNDARY(colorTemperature,           ZCL_READONLY_ATTRIBUTE, ZCL_ZLL_CLUSTER_COLOR_TEMPERATURE_SERVER_ATTRIBUTE_ID,              ZCL_U16BIT_DATA_TYPE_ID, 0x0000, 0xFEFF),   \
