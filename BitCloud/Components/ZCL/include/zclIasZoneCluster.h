...
*/
#define ZCL_IAS_ZONE_CLUSTER_SERVER_ATTRIBUTES_AMOUNT                           7
...
typedef enum{
  ...
  ZCL_IAS_ZONE_CLUSTER_ZONE_STATUS_ATTRIBUTE_TEST_MODE_TO_OPERATION_MODE = 0xFEFF,
...
} ZCL_IasZoneClusterAttributes_t;
END_PACK
